...
function optionsframework_options() {
	...
	// design options
	$options[] = array(
		'name' 	=> __('Foo', 'options_framework_theme'),
		'type' 	=> 'heading'
	);
	...
	$options[] = array(
		...
		'desc' 	=> __('Need a custom logo? Upload it here!', 'options_framework_theme'),
		'id' 	=> 'skeleton_logo',
		'type' 	=> 'upload'
	);
	...
	$options[] = array(
		'name' 				=> __("Layout Selection", "options_framework_theme"),
		'desc' 				=> "Choose your preferred layout. By default, the theme will have a single left sidebar selected.",
		'id' 				=> "skeleton_layout_selection",
		'std' 				=> "2c-l-fixed",
		'type' 				=> "images",
		'options' 			=> array(
			...
			'3c-b-fixed' 	=> $imagepath . '3cb.png',
			'3c-l-fixed' 	=> $imagepath . '3cl.png',
			'3c-r-fixed' 	=> $imagepath . '3cr.png'
		)
	);

	$options[] = array(
		'name' 	=>  __('Background Styles', 'options_framework_theme'),
		'desc' 	=> __('Change the background CSS or upload a custom image.', 'options_framework_theme'),
		'id' 	=> 'skeleton_background_styles',
	...
	$options[] = array(
		'name' => __('Body Typography', 'options_framework_theme'),
		'desc' => __('Change the appearance of the body text.', 'options_framework_theme'),
		'id' => "skeleton_body_typography",
	...
	$options[] = array(
		'name' => __('Anchor Color', 'options_framework_theme'),
		'desc' => __('Choose a default anchor color', 'options_framework_theme'),
		'id' => 'skeleton_anchor_color',
		'std' => '',
		'type' => 'color'
	);
